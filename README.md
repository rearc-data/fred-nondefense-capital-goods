...
Manufacturers' New Orders: Nondefense Capital Goods Excluding Aircraft | FRED
=========================
...
## More Information
- Source: [Federal Reserve Economic Data (FRED)](https://fred.stlouisfed.org/series/NEWORDER)
...
## Contact Details
- If you find any issues with or have enhancement ideas for this product, open up a GitHub [issue](https://github.com/rearc-data/fred-nondefense-capital-goods/issues) and we will gladly take a look at it. Better yet, submit a pull request. Any contributions you make are greatly appreciated :heart:.
